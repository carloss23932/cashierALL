                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="bg-gray-100 p-4 rounded-lg">
                    <div className="flex justify-between items-center text-lg font-bold">
                      ...
                      <span className="text-blue-600">{formatCurrency(calculateTotal())} د.ع</span>
                    </div>
                  </div>
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <div className="text-left">
                        <div className="text-lg font-bold text-blue-600">
                          {formatCurrency(invoice.total)} د.ع
                        </div>
            ...
            <div className="space-y-6">
                  ...
                  <TableBody>
                    {selectedInvoice.items.map((item, index) => (
                      <TableRow key={index}>
                        ...
                        <TableCell>{formatCurrency(item.purchasePrice)} د.ع</TableCell>
                        <TableCell className="text-green-600 font-medium">{formatCurrency(item.salePrice)} د.ع</TableCell>
                        <TableCell>{item.quantity}</TableCell>
                        <TableCell className="font-semibold">
                          {formatCurrency(item.purchasePrice * item.quantity)} د.ع
                        </TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
              ...
              <div className="border-t pt-4">
                <div className="flex justify-between items-center text-xl font-bold">
                  ...
                  <span className="text-blue-600">{formatCurrency(selectedInvoice.total)} د.ع</span>
                </div>
              </div>
